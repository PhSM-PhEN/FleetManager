...
namespace UseCase.Tests.ToTenant.Deactivate
{
    public class DeactivateTenantUseCaseTest
    {
        [Fact]
        ...
        public async Task Error_Already_Deactivated()
        {
            ...
            result.Message.ShouldBe(ResourceErrorMessages.TENANT_ALREADY_DEACTIVATED);
        }

        private static DeactivateTenantUseCase CreateUseCase(Tenant? tenant)
        {
            ...
            return new DeactivateTenantUseCase(repository, unitOfWork);
        }
    }
}
