...
namespace WebApi.Tests.ToRentalPlan.GetAll
{
    public class GetAllRentalPlanUseCaseTest : FleetManagerClassFixture
    {
        private const string METHOD = "api/RentalPlan";
        private readonly string _teamMemberToken;

        public GetAllRentalPlanUseCaseTest(CustomWebApplicationFactory customWebApplication) : base(customWebApplication)
        {
