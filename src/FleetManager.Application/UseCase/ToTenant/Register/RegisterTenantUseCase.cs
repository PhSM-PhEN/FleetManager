...
{
    public class RegisterTenantUseCase(ITenantWriteOnlyRepository repository,IAddressReadOnlyRepository addressReadOnly , IUnitOfWork unitOfWork) : IRegisterTenantUseCase
    {
